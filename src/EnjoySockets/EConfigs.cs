...
namespace EnjoySockets
{
    public class EConfig
    {
        ...
        /// </summary>
        public virtual EConfig Clone()
        {
            return new();
        }
    }

    public sealed class EClientConfig : EConfig
    {
        /// <summary>
        ...
        public EClientConfig()
        {
            Heartbeat = 0;
        }

        public override EClientConfig Clone()
        {
            return new EClientConfig
            {
    ...
    public sealed class EServerConfig : EConfig
    {
        /// <summary>
        ...
        public override EServerConfig Clone()
        {
            return new EServerConfig
            {
