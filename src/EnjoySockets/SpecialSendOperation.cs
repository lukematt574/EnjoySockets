...
{
    internal class SpecialSendOperationPool
    {
        readonly ConcurrentStack<SpecialSendOperation> _pool = new();
        internal SpecialSendOperation Rent()
        {
            if (_pool.TryPop(out var operation))
                return operation;
            else
                return new SpecialSendOperation();
        }

        internal void Return(SpecialSendOperation? operation)
        {
    ...
    internal class SpecialSendOperation
    {
